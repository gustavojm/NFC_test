...
void gui_task(void *args)
{
	...
	pole_direction_label = GTK_WIDGET(gtk_builder_get_object(builder, "pole_direction_label"));
	...
	lift_downLimit = GTK_WIDGET(gtk_builder_get_object(builder, "lift_downLimit"));
